...
#define   LEN(arr)  ((int)(sizeof(arr)[0]))   // LEN calculation macro
...
void chip_init() {
  ...
  // Setup GPS TX Array Index
  chip->gps_tx_index  = 0;

  // Setup Timer Event Handling
